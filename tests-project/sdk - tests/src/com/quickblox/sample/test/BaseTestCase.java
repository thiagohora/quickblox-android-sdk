...
public class BaseTestCase extends InstrumentationTestCase {
    ...
    protected QBCustomObject getObjectFromCollection(List<QBCustomObject> qbCustomObjectsList, String key,
            String value) {
    ...
    protected void checkHttpStatus(int successCode, Result result) {
        if (result.getStatusCode() == successCode) {
            ...
            fail("result: " + result.getStatusCode() + " but must be: " + successCode);
        }
    }
}
